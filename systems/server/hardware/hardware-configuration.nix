...

{
  ...
  boot.initrd.availableKernelModules =
    [ "nvme" "xhci_pci" "ahci" "thunderbolt" "sd_mod" ];
  ...
  fileSystems."/home/admin" = {
    ...
    fsType = "zfs";
    # This contains the ssh keys for agenix and needs to be available
    # to load the secrets at boot time.
    neededForBoot = true;
  };
  ...
  # networking.interfaces.br-cb16995e5a61.useDHCP = lib.mkDefault true;
  # networking.interfaces.docker0.useDHCP = lib.mkDefault true;
  # networking.interfaces.enp6s0.useDHCP = lib.mkDefault true;
  # networking.interfaces.tailscale0.useDHCP = lib.mkDefault true;
  # networking.interfaces.vethf5401e3.useDHCP = lib.mkDefault true;
